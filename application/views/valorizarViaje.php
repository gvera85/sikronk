                                            ...
                                            ?>  
                                                <tr class="warning">
                                                  ...
                                                  <TD class="text-nowrap">
                                                      ...
                                                      $ <input type="number" step="any" class="importe_linea_<?php echo $cantidad ?>" style="width:65px; text-align:right; font-size: small;" tabindex="<?php echo $cantidadLineasReparto?>" id="precioBulto_<?php echo $cantidadLineasReparto?>" onChange="calcularPrecioLinea(this.value,bultos_<?php echo $cantidadLineasReparto?>.value, cant_merma_<?php echo $cantidadLineasReparto?>.value, 'div#precioTotal_<?php echo $cantidadLineasReparto?>'); calcularTotales();" name="precioBulto[]" size="10" value="<?php echo $reparto['precio_caja'] ?>"> 
                                                      </span>
                                                  </TD>
