...
<head>
    ...
    <title>sikronk - Detalle de crédito</title>
    ...
    $(document).ready(function(){
       ...
       $(document).on("click","#btnInfoCheque",function( event ) {  
            ...
            $.ajax({                        
                        url:"<?php echo base_url() ?>index.php/detallesEntidades/verDetalleChequeCredito/"+miBoton
                  })
                      .done(function(data) {
...
<div id="container" style="padding: 10px;">
            <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"> 
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse1">Resumen del crédito</a>
                        </h3>
                    </div>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse2"> Detalle del crédito </a>
                    </h3>
                ...
                <div id="collapse2" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <table id="tblDetalle" class="table compact table-striped table-hover table-condensed table-responsive">
                            ...
                            <tbody>
                            <?php
                            if (!empty($lineasCredito[0]['id']))
                            {
                                foreach( $lineasCredito as $lineas ) : ?>
                                       <tr>
                                           <td id="producto">$<?php echo $lineas['importe'] ?></td>
                                           <td id="producto">
                                           <?php if ($lineas['id_modo_pago'] == 3) 
                                           {?>    
