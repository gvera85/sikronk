...
class estado extends CI_Controller{
  ...
  function index(){
    ...
    $this->grocery_crud->edit_fields('descripcion','id_tipo_estado');
    $this->grocery_crud->add_fields('descripcion','id_tipo_estado');
    
    $this->grocery_crud->set_theme('datatables');
   
    $this->grocery_crud->set_subject('Estado');
    $this->grocery_crud->required_fields('descripcion','id_tipo_estado');
    $this->grocery_crud->columns('descripcion','id_tipo_estado');
