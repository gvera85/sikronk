...
class Valorizar extends CI_Controller{
  ...
  function index(){
    ...
    $this->grocery_crud->columns('id','numero_de_viaje','id_proveedor','numero_de_remito','fecha_estimada_arribo','patente_semi','patente_camion','id_empresa_transportista','id_estado','cantidad_productos');
