...
class salidaCajaLineas extends CI_Controller{
  ...
  function popUp($id_distribuidor, $primary_key){
    ...
    $crud->fields('id_debito', 'id_modo_pago', 'id_cheque_distribuidor', 'importe', 'numero_de_cheque',  'fecha_de_acreditacion','id_entidad_bancaria', 'id_sucursal_bancaria', 'cuit', 'observaciones');
  ...
  public function validarPagoEnChequePropio($idBanco) 
  {
