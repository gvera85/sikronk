...
define('ESTADO_CHEQUE_DIST_SIN_USAR','15');
define('ESTADO_CHEQUE_DIST_USADO_CON_PROVEEDOR','16');
define('ESTADO_CHEQUE_DIST_USADO_CON_DISTRIBUIDOR','17');
define('ESTADO_CHEQUE_DIST_SALDADO','18');
define('ESTADO_VIAJE_ANULADO','19');
define('ESTADO_CHEQUE_DIST_DESCONTADO_CUENTA','20');
