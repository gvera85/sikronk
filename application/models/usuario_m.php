...
class usuario_m extends CI_Model {
    ...
    {
        if($idUsuario != FALSE) {
          $sql = "select a.id id_linea, c.id id_perfil, a.id_perfil_proveedor id_perfil, b.razon_social empresa, b.imagen_logo, c.descripcion perfil, a.id_proveedor id_empresa, a.id_usuario
    ...
    {
        if($idUsuario != FALSE) {
          $sql = "select a.id id_linea, c.id id_perfil, a.id_perfil_cliente id_perfil, b.razon_social empresa, b.imagen_logo, c.descripcion perfil, a.id_cliente id_empresa, a.id_usuario
